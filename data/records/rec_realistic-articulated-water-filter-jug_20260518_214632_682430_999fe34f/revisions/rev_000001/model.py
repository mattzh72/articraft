...
def build_object_model() -> ArticulatedObject:
    ...
    lid = model.part("lid")
    _box_part(lid, "front_lid_panel", (0.082, 0.108, 0.008), (0.041, 0.0, 0.004), clear_blue)
    ...
    _box_part(lid, "status_indicator", (0.038, 0.022, 0.003), (0.045, 0.0, 0.0095), charcoal)
...
def run_tests() -> TestReport:
    ...
    ctx.check("six semantic links", len(object_model.parts) == 6, details=f"parts={[p.name for p in object_model.parts]}")
