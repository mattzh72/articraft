...
def _fit_camera_distance(half_extents, res_x: int, res_y: int, azimuth_deg: float) -> float:
    ...
    MARGIN = 1.08  # ~8% breathing room — tight enough that small objects fill the frame
...
def main():
    ...
    # Compute bounds across all articulation poses so motion_30 never clips.
    ...
    _OVERLAY_ON_MOTION = set() if args.no_joint_overlay else {"motion_1", "motion_30"}
